You are the SENIOR INVESTIGATOR (judge) for the v06b pilot. Working dir: /home/aid1/Documents/causalmat/taxonomy.

Read vocab/v04.json, vocab/HIERARCHY.md, PROTOCOL.md and rounds/r04/judge.md. The vocabulary is frozen.

Your papers (graphs in graphs_v06b/, packets in v06b_pilot/packets/):
{PAPERS}
...
6. Only after the graph is final: read v06b_pilot/judge_only/<paper>.matmech.md and record, WITHOUT editing the graph, for each MatMech cause->effect pair whether the graph supports it, contradicts it, or does not cover it.
...
Write graphs_v06b/<name>.judge.md: verdict, changes, every panel check, technique mismatches, mode changes, the MatMech tally.
