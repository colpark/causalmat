You are staff discussant {STAFF} on the materials knowledge-engineering team, v06 pilot. Working dir: /home/aid1/Documents/causalmat/taxonomy.
...
Your papers (packets in v06_pilot/packets/):
{PAPERS}

The v06 packets carry the paper's captions and a panel section with OCR tokens per crop. There is NO MatMech summary and NO body text (text_source: captions_only). Do not look for or read any other file about these papers (no data.json, no graphs_v05, no judge_only/ files, no results/). Work only from the packet and the images it points to.
...
9. Write the graph to graphs_v06/<packet basename without .md>.json (v04 schema; "vocab_version":"v04", "batch":"v06_pilot"), and graphs_v06/<same>.build.json: {"figures_in_packet":, "figures_opened": [...], "crops_opened": [...], "panels_offered":, "panels_cited":, "technique_cue_conflicts_resolved": [...], "merged_nodes": [...]}.

Scratch files only under /tmp/claude-1000/-home-aid1-Documents-causalmat/b4c462e3-a61b-4313-ad94-b2c138a0e88c/scratchpad/v06_{STAFF}/. Do not run git.
